...
const blogTheme = getThemeConfig({
  comment: {
    type: 'giscus',
    options: {
      repo: 'DanRan-hcy/blog',
      repoId: 'R_kgDONH0bIA',
      category: 'General',
      categoryId: 'DIC_kwDONH0bIM4Co6hY',
      inputPosition: 'top'
    },
    // 自定义展示内容
    label: '发表意见',
...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { name: 'google-site-verification', content: 'egm1goU17DznjndARCeOFiO1mioJ5t0CkPWmIbxp7Pw' }]
  ],
  themeConfig: {
    // 展示 2,3 级标题在目录中
    outline: {
    ...
    socialLinks: [
      {
        icon: 'github',
        link: 'https://github.com/DanRan-hcy'
      }
    ]
  }
})
